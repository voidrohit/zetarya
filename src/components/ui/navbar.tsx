...
const Navbar = () => {
  ...
  return (
      <>
        <div className="flex flex-row justify-between items-center max-w-[1280px] w-[90vw] h-20 text-black bg-white nav overflow-hidden">
          <div className="flex flex-row items-center ">
              ...
              <ul className="hidden md:flex">
                  {links.map(({ id, link }) => (
                      <li
                          key={id}
                          className="nav-links px-4 cursor-pointer capitalize font-medium text-gray-500 hover:text-gray-400 duration-200 link-underline"
                      >
          ...
          {nav && (
              <ul className="flex z-[9999] flex-col justify-center items-center absolute overflow-hidden top-0 left-0 w-screen h-screen bg-white">
                {links.map(({ id, link }) => (
                    <li
                        key={id}
