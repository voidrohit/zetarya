        ...
        <div className="flex max-w-[1280px] w-[90vw] mx-auto pt-[2rem] lg:pt-[3rem] justify-center items-center flex-col relative z-10">
          <div className="main">
            ...
            <div className="flex mt-5 h-[100px] justify-center">
              <span
                  className="bg-[#801336] cursor-pointer w-[350px] h-[50px] rounded-[10px] text-[18px] text-white mt-[22px] font-semibold flex items-center justify-center gap-3
                  transition-all duration-300 ease-in-out
               hover:ring-2 hover:ring-[#801336]
      hover:ring-offset-4"
              >
                  <svg className="w-2 h-6 sm:w-4 sm:h-7 lg:w-3 lg:h-8" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" viewBox="0 0 814 1000">
