...
const STORY = [
  ...
  "Zetarya is that link. It runs on desktop and mobile, straight between your devices, and it keeps nothing. Fifteen of us work on it now, across four time zones, and we still measure every release against a motorcycle.",
];
