...
const PrivacyPolicy = () => {
  return (
    <div className="flex justify-center align-center flex-col scroll-smooth">
        ...
        <p className="text-lg text-gray-600 mb-8">Effective Date: April 4, 2024</p>
        ...
        <section className="mb-12">
            ...
            <p className='text-gray-700 mb-4'>
            Prices indicated on this website are subject to change without prior notice from TeamDev. Request an official quote for the purpose of purchase processing.
            </p>
        </section>
        <section className="mb-12">
